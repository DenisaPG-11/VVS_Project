...
public class Proiectvvs2Test {
  ...
  @Test
  public void proiectvvs2() {
    driver.get("http://127.0.0.1:8080/first");
    driver.manage().window().setSize(new Dimension(747, 990));
    ...
    driver.findElement(By.linkText("back")).click();
    {
      WebElement element = driver.findElement(By.linkText("back"));
